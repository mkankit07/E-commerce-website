...
import { fetchAllProductAsync, fetchProductByFilterAsync, selectproduct } from '../productSlice'
...
const ProductList = () => {
  ...
  const handleFilter=(e,section,option)=>{
    const newFilter={...filter,[section.id]:option}
    setFilter(newFilter)
                                ...
                                {section.options.map((option, optionIdx) => (
                                  <div key={option.value} className="flex items-center">
                                    <input
                                      ...
                                      onChange={(e)=>{handleFilter(e,section,e.target.value)}}
                ...
                <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
                  <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                    {products.map((product) => (
                     ...
                     <Link to="product-detial"><div className="min-h-60 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-60">
                          <img
                        ...
                        <div className="mt-4 flex justify-between">
                         ...
                         <p className="text-sm line-through font-medium text-gray-900"> ${product.price}</p>
                         </div>
                        </div></Link>
